...
list_construct = list() #생성 함수를 이용하여 리스트 생성
print(type(list_construct))
tuple_empty = ()
print(type(tuple_empty))
tuple_construct = tuple() #생성 함수
print(type(tuple_construct))
set_consturct = set() #생성 함수
...
s.remove(1) #set의 삭제는 pop이 아닌 remove를 사용합니다.
print(s)
# s.remove(1) #없는 값을 삭제할 경우 에러가 발생합니다.
s.discard(2) #set의 삭제는 remove 이외에도 discard를 사용할 수 있습니다.
print(s)
